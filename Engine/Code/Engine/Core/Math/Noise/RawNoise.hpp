...
// Changes
// 
// Namespaced functions to add granularity
// Modified function names to match with the current engine's style
//
/////////////////////////////////////////////////////////////////////////////////////////////////
...
//
constexpr unsigned int GetNoiseUint( int index, unsigned int seed=0 );
constexpr unsigned int GetNoiseUint( int indexX, int indexY, unsigned int seed=0 );
constexpr unsigned int GetNoiseUint( int indexX, int indexY, int indexZ, unsigned int seed=0 );
constexpr unsigned int GetNoiseUint( int indexX, int indexY, int indexZ, int indexT, unsigned int seed=0 );

//-----------------------------------------------------------------------------------------------
// Same functions, mapped to floats in [0,1] for convenience.
//
constexpr float GetNoiseZeroToOne( int index, unsigned int seed=0 );
constexpr float GetNoiseZeroToOne( int indexX, int indexY, unsigned int seed=0 );
constexpr float GetNoiseZeroToOne( int indexX, int indexY, int indexZ, unsigned int seed=0 );
constexpr float GetNoiseZeroToOne( int indexX, int indexY, int indexZ, int indexT, unsigned int seed=0 );
...
//
constexpr unsigned int RawNoise::GetNoiseUint( int positionX, unsigned int seed )
{
...
//-----------------------------------------------------------------------------------------------
constexpr unsigned int RawNoise::GetNoiseUint( int indexX, int indexY, unsigned int seed )
{
	constexpr int PRIME_NUMBER = 198491317; // Large prime number with non-boring bits
	return GetNoiseUint( indexX + (PRIME_NUMBER * indexY), seed );
}

//-----------------------------------------------------------------------------------------------
constexpr unsigned int RawNoise::GetNoiseUint( int indexX, int indexY, int indexZ, unsigned int seed )
{
	...
	return GetNoiseUint( indexX + (PRIME1 * indexY) + (PRIME2 * indexZ), seed );
}

//-----------------------------------------------------------------------------------------------
constexpr unsigned int RawNoise::GetNoiseUint( int indexX, int indexY, int indexZ, int indexT, unsigned int seed )
{
	constexpr int PRIME1 = 198491317; // Large prime number with non-boring bits
	constexpr int PRIME2 = 6542989; // Large prime number with distinct and non-boring bits
	constexpr int PRIME3 = 357239; // Large prime number with distinct and non-boring bits
	return GetNoiseUint( indexX + (PRIME1 * indexY) + (PRIME2 * indexZ) + (PRIME3 * indexT), seed );
}

//-----------------------------------------------------------------------------------------------
constexpr float RawNoise::GetNoiseZeroToOne( int index, unsigned int seed )
{
	constexpr double ONE_OVER_MAX_UINT = (1.0 / (double) 0xFFFFFFFF);
	return (float)( ONE_OVER_MAX_UINT * (double) RawNoise::GetNoiseUint( index, seed ) );
}

//-----------------------------------------------------------------------------------------------
constexpr float RawNoise::GetNoiseZeroToOne( int indexX, int indexY, unsigned int seed )
{
	const double ONE_OVER_MAX_UINT = (1.0 / (double) 0xFFFFFFFF);
	return (float)( ONE_OVER_MAX_UINT * (double) RawNoise::GetNoiseUint( indexX, indexY, seed ) );
}

//-----------------------------------------------------------------------------------------------
constexpr float RawNoise::GetNoiseZeroToOne( int indexX, int indexY, int indexZ, unsigned int seed )
{
	const double ONE_OVER_MAX_UINT = (1.0 / (double) 0xFFFFFFFF);
	return (float)( ONE_OVER_MAX_UINT * (double) RawNoise::GetNoiseUint( indexX, indexY, indexZ, seed ) );
}

//-----------------------------------------------------------------------------------------------
constexpr float RawNoise::GetNoiseZeroToOne( int indexX, int indexY, int indexZ, int indexT, unsigned int seed )
{
	const double ONE_OVER_MAX_UINT = (1.0 / (double) 0xFFFFFFFF);
	return (float)( ONE_OVER_MAX_UINT * (double) RawNoise::GetNoiseUint( indexX, indexY, indexZ, indexT, seed ) );
}
